...
export function OrderSucess() {
  return (
    <main className="w-full h-screen flex items-center justify-center bg-[#F9F9F9]  flex-col gap-3">
        ...
        <div className="flex flex-col items-center justify-center gap-8">
            ...
            <p className="text-[11px] text-[#777777]">Lorem ipsum dolor sit amet consectetur. Sapien ut libero sed lacinia egestas placera</p>
        </div>
    </main>
  );
}
