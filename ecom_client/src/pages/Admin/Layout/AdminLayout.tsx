...
import { Box, Codepen,  Menu, Package2, UserCog } from "lucide-react";
    ...
    <main className="h-screen flex gap-2 lg:p-5 overflow-hidden  ">
      <aside className="w-72 h-full bg-slate-100 px-3 rounded-sm ">
        ...
        <div className="mt-2 flex flex-col gap-2">
          <Link to={"users"} className="h-10 w-full bg-slate-200 rounded-lg flex items-center gap-3 px-5">
          ...
          <Link to={"brands"} className="h-10 w-full bg-slate-200 rounded-lg flex items-center gap-3 px-5">
